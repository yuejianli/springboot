...
(function ($) {
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        this.$body.find('tr').on("click", function(e){
    		$('.bootstrap-table .unified').removeClass('unified');
    		$(this).toggleClass('unified');
        });
    ...
    BootstrapTable.prototype.toggleAllColumns = function (visible) {
    	//现在的实现方法，显示所有的列
    	var toggleColumns = this.columns;
    	$.each(toggleColumns, function (i,column){
    		toggleColumns[i].visible = visible;
    	});
