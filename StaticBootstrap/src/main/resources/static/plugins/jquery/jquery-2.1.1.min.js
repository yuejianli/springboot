...
!function(a, b) {
    ...
    n.event = {
        ...
        add:function(a, b, c, d, e) {
            ...
            if (r) {
                ...
                o && (l = n.event.special[o] || {}, o = (e ? l.delegateType :l.bindType) || o, l = n.event.special[o] || {}, 
                k = n.extend({
                    type:o,
                    origType:q,
                    data:d,
    ...
    n.extend({
        ...
        ajax:function(a, b) {
            ...
            if("object" == typeof b && !b.hasOwnProperty("dataFilter") ){
                b.dataFilter = function(data, type){
